...
export default function TireItems() {
  ...
  return (
    ...
    >
      <Link className="fixed top-5 right-5 md:right-10" to={'/tires'}>
        {icons.closePage}
      </Link>

      <div className="flex items-center justify-center gap-[30px] md:gap-[75px] w-full flex-col md:flex-row">
        <img
