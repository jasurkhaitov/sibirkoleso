...
export default function Contact() {
  return (
    <div className={`${styles.pageContainer} mt-4`}>
      ...
      <div className="grid grid-cols sm:grid-cols-2 border-b border-gray-400 pb-5">
            ...
            {contactData.managersData.map((item) => {
              return (
                ...
                >
                  ...
                  <p className="text-[14px] font-opensans font-medium">
                  ...
                  <p className="text-[14px] font-opensans font-medium">
                    ИНН:{' '}
                    <span className="text-[13px] font-light">{item.inn}</span>
                  </p>
                  ...
                  <p className="text-[14px] font-opensans font-medium">
                    БИК:{' '}
                    <span className="text-[13px] font-light">{item.bik}</span>
                  </p>
